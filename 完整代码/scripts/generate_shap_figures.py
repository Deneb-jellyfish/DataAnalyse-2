...
def main() -> None:
    ...
    make_shap_fig(
        model_path=str(resolve_artifact_path("xgboost_h1.pkl")),
        pred_csv  =str(resolve_artifact_path("xgboost_predictions_h1.csv")),
    ...
    make_shap_fig(
        model_path=str(resolve_artifact_path("xgboost_seq6_h6.pkl")),
        pred_csv  =str(resolve_artifact_path("xgboost_predictions_seq6.csv")),
