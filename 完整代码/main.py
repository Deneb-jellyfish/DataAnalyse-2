"""One-click preprocessing entry point for the hourly AQI experiment."""
...
def run_features(granularity: str = "hourly") -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Feature granularity to build (default: hourly)",
    )
