...
def main() -> None:
    ...
    h1_params_path = OUTPUT_DIR / "xgboost_h1_best_params.json"
    ...
    seq6_params_path = OUTPUT_DIR / "xgboost_seq6_best_params.json"
    ...
    pd.concat(pred_frames, ignore_index=True).to_csv(OUTPUT_DIR / "cross_city_predictions.csv", index=False)
