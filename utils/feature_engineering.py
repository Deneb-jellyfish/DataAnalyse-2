...
def build_feature_matrices(
    ...
    input_path = input_path or (PROCESSED_DIR / "beijing.csv")
    ...
    dates_train = train_frame["date"].dt.strftime("%Y-%m-%d").to_numpy()
    dates_test = test_frame["date"].dt.strftime("%Y-%m-%d").to_numpy()
